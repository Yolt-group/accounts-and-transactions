...
/**
 * This tests uses real-world (anonymized) data from a Barclays user.
 */
public class TransactionReconciliationWithBarclaysData2Test {
    ...
    public void given_aTransactionsIdChangesAcrossRefreshes_when_reconcileTransactions_then_weCanReconcileBasedOnAttributes() throws Throwable {
        ...
        List<ProviderTransactionDTO> first = new ArrayList<>(objectMapper.readValue(getClass().getResourceAsStream("/transactionmatching/barclays/2020-04-28T14_00.anon.json").readAllBytes(), new TypeReference<List<ProviderTransactionDTO>>() {
        }));
        List<ProviderTransactionDTO> second = new ArrayList<>(objectMapper.readValue(getClass().getResourceAsStream("/transactionmatching/barclays/2020-04-28T23_00.anon.json").readAllBytes(), new TypeReference<List<ProviderTransactionDTO>>() {
        }));
        ...
        assertThat(result.getMetrics()).isEqualToComparingFieldByField(TransactionReconciliationResultMetrics.builder()
                .provider("BARCLAYS")
                .upstreamTotal(104)
                .upstreamUnchanged(104)
                .storedTotal(104)
                .storedMatchedByAttributesUnique(63)
                .storedMatchedByAttributesOptimistic(41)
                .upstreamQualityMissingExternalIds(104)
                .build());
    }
