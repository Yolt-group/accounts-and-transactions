 ...
 */
public class TransactionReconciliationWithBarclaysDataTest {
    ...
    public void given_aTransactionsIdChangesAcrossRefreshes_when_reconcileTransactions_then_weCanReconcileBasedOnAttributes() throws Throwable {
        ...
        List<ProviderTransactionDTO> first = new ArrayList<>(objectMapper.readValue(getClass().getResourceAsStream("/transactionmatching/barclays/2020-03-30T16_03.anon.json").readAllBytes(), new TypeReference<List<ProviderTransactionDTO>>() {
        }));
        List<ProviderTransactionDTO> second = new ArrayList<>(objectMapper.readValue(getClass().getResourceAsStream("/transactionmatching/barclays/2020-03-31T04_34.anon.json").readAllBytes(), new TypeReference<List<ProviderTransactionDTO>>() {
        }));
        ...
        assertThat(result.getMetrics()).isEqualToComparingFieldByField(TransactionReconciliationResultMetrics.builder()
                ...
                .upstreamTotal(259)
                .upstreamNew(3)
                .upstreamUnchanged(254)
                .storedTotal(256)
                .storedMatchedByAttributesUnique(247)
                .storedMatchedByAttributesOptimistic(9)
                .upstreamQualityMissingExternalIds(259)
                .build());
    }
